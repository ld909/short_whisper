...
输出:
    - Intel Mac: /Volumes/dhl/audio/thriller/story_param/
    - Apple Silicon Mac: /Users/donghaoliu/Documents/audio/thriller/story_param/
...
def get_output_directory():
    ...
    if base_dir:
        output_dir = f"{base_dir}/thriller/story_param"
    ...
    if platform.system() == "Darwin":
        ...
        if is_apple_silicon:
            output_dir = "/Users/donghaoliu/Documents/audio/thriller/story_param"
            print(f"🍎 检测到Apple Silicon Mac，使用路径: {output_dir}")
        else:
            output_dir = "/Volumes/dhl/audio/thriller/story_param"
            print(f"💻 检测到Intel Mac，使用路径: {output_dir}")

        return output_dir

    # 其他系统暂时不支持
    return "/Users/donghaoliu/Documents/audio/thriller/story_param"
