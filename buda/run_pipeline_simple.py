...
def check_conda_environment():
    ...
    if 'CONDA_DEFAULT_ENV' in os.environ:
        ...
        # 检查是否是audio环境
        if current_env != 'audio':
            print(f"⚠️  当前环境是 {current_env}，需要切换到 audio 环境")
            return False
        return True
    else:
        print("❌ 未检测到conda环境")
...
def main():
    ...
    scripts = [
        ...
        ("title_translator_multi_lang.py", "10.1. 生成多语言标题翻译结果", ["-l", "English", "Korean"]),
    ...
    if success_count == len(scripts):
        ...
        if failed_scripts:
            ...
            print("\n💡 故障排除建议:")
            print("1. 检查conda环境是否正确激活: conda activate audio")
